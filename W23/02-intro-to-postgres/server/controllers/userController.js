...
export const handleRegister = async (req, res) => {
  try {
    ...
    if (!errors.isEmpty()) {
      // if there are errors send back a response
...
export const handleRegisterPostgres = async (req, res) => {
  try {
    console.log("this is register PG", req.body);
    ...
    req.body.password = hash;
    const newUser = await UserPG.create(req.body);
    console.log("🚀 ~ newUser:", newUser);
...
export const handleLoginNoCookiePG = async (req, res, next) => {
  try {
    console.log("this is login", req.body);
